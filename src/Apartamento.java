public class Apartamento extends Imovel{
    ...
    public Apartamento(Endereco endereco, double valor, double area, int andar, int numeroApt, double vlrCondominio, double iptu) throws ValorImovelInvalidoException, AreaInvalidaException {
